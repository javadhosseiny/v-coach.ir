...
<head>
	...
	if ($row_setting['iconfile']!='') {	
		...
		echo "<link rel='shortcut icon' href='$iconfile'>\n"; 	
	}
    ...
    <!-- main-style---------------------------------->
    <link rel="stylesheet" href="/assets/css/main.css?01234">
	...
	<div class="d-block">
						...
						<div class="header-search row text-right ">
							<div class="header-search-box ">
								<form action="/search/" class="form-search" method='post'>
									<input type="search" class="header-search-input" name="varsearch"
						...
						<div class="d-block">
							<div class="account-box">
								<div class="nav-account d-block pl">
									<?php 
									if ($userphoto=='')  { $TagPhoto = "/assets/images/man.png";}
										else { $TagPhoto = $userphoto;}
									echo "<span class='icon-account'><img src='$TagPhoto' class='avator'></span>";
									//-----------------------
									if (!$ok_cookie) { 
										echo "
										<a class='title-account ml-1' href='/login/'>ورود |</a>
										<a class='title-account ml-2' href='/register/'>ثبت نام</a>"; 
									} else { 
									?>
									<span class='title-account'>حساب کاربری</span>
									<div class="dropdown-menu">
										<div class='title-account'><?php echo $usernamefarsi;?></div>
										<ul class="account-uls mb-0">
											<li class="account-item">
												<a href="/profile/" class="account-link">پروفایل</a>
											</li>
											<li class="account-item">
												<a href="/mypassword/" class="account-link">تغییر رمز</a>
											</li>
											<li class="account-item">
												<a href="/myorder/" class="account-link">سفارشات من</a>
											</li>
											<li class="account-item">
												<a href="/myaddres/" class="account-link">آدرس های من</a>
											</li>
											<li class="account-item">
												<a href="/myfavorite/" class="account-link">علاقه مندی ها</a>
											</li>
											<li class="account-item">
		...
		<nav class="header-main-nav">
			<div class="d-block">
				<div class="row align-items-center" style='margin-right: 15px;  margin-left: 0px;'>
					<?php 
					if ($ok_cookie) {$col1 = 'col-9'; } else { $col1='col-12'; } 
					$col1 = 'col-12';
		...
		<nav class="sidebar">
			<div class="nav-header">
				...
				<div class="logo-wrap" class="logo-icon">
					<a href="/">
						<?php echo "<img src='$logofile' style='max-height:50px;' alt='$title'>"; ?>
					</a>
				</div>
...
//	echo "schema=$schema";
	...
	if (($schema=='NewsArticle') or ($schema=='BlogPosting') ) {
		$title 		= $row_content['tetr'];
		$url 		= $main_url;
		$published	= jalaliToG($row_content['date']).'T'.$row_content['time'];
