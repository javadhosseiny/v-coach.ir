...
//----------------------------------------------------------------------------------------------------
    ...
    var $graphBGColor = 'black';                    // graph background color: string
    ...
    var $titleFont = 'Tahoma, Helvetica';       // title font family: string (CSS specification)
    ...
    var $labelFont = 'Tahoma, Helvetica';       // label font family: string (CSS specification)
    ...
    var $percValuesFont = 'Tahoma, Helvetica';  // perc. values font family: string (CSS specification)
    ...
    var $legendFont = 'Tahoma, Helvetica';      // legend font family: string (CSS specification)
...
//----------------------------------------------------------------------------------------------------
    ...
    function build_bar($value, $width, $height, $color) {
      ...
      $bg = stristr($access,'\.(jpg|jpeg|jpe|gif|png)$', $color) ? 'background' : 'bgcolor';
