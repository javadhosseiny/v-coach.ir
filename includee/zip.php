...
{
default:
//echo "<strong>SHANKIMOUT ZIP EXTRACTOR</strong>
//<form action=\"zip.php?section=ex\" method=\"post\">
//File Name : <input name=\"fname\" type=\"Text\"><br><br>
//Dir To Extract : <input name=\"dir\" value=\".\\\" type=\"Text\"><br><br>
//<input type=\"Submit\" value=\"Extract\"><br><br>
//</form>
//";
break;
case "ex":
$FS = New PclZip($_POST['fname']);
$FS->extract($_POST['dir'], $p_remove_path="");
echo "Okay!<br>";
echo $_POST['fname'] . " Content Extracted To " . $_POST['dir'];
break;
}
?>